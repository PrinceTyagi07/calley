...
const Choice = () => {
  return (
    ...
    <h1 className='text-4xl py-10 font-bold text-black text-center'>Make the best choice</h1>
    <p className=''>Select the concern you’re facing and we will recommend you Kaya’s most efficacious skin care products</p>
    </div>
